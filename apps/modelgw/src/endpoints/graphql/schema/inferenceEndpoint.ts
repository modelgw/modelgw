...
export const inferenceEndpointResolvers = {
  Query: {
    inferenceEndpoints: async (_parent: any, args: any, { user, prismaClient }: ServerContext, _info: any) => {
  ...
  Gateway: {
    inferenceEndpoints: async (parent: Gateway, args: any, { user, prismaClient: prisma }: ServerContext, _info: any) => {
      return findManyCursorConnection(
